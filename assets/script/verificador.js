...
function checkRut(rut) {
  ...
  // El método slice nos permite separar los caracteres, cuerpo sería entonces todo menos el digito verificador
  // El -1 se ocupa como (largo del rut - 1).
  // toUpperCase se ocupa para convertir el DV en mayúscula.
  ...
  for (i = 1; i <= cuerpo.length; i++) {
    ...
    // Entiendo que por el "++" i comienza como 2, por lo que charAt tomará el penúltimo número, es decir, el número antes del DV

    index = multiplo * valor.charAt(cuerpo.length - i);

    // Sumar al Contador General
    // Se añade a la suma total para luego dividirlo
    suma = suma + index;
